...
class ScatterPlot(CustomAxesImage,object):
    ...
    def __init__(self,ax,x,y,s=1,**kwargs):
        ...
        if debug > 1: print("scatterplot: initialized")
    ...
    def calculate_xypixels(self,*args,**kwargs):
        ...
        if debug > 1:
            print("scatterplot: xpixels,ypixels =",self.xpixels,self.ypixels)
    ...
    def calculate(self,*args,**kwargs):
        ...
        if any(idx):
            ...
            if debug > 0: print("scatterplot: took %f seconds" % (time()-start))
    ...
    if has_jit:
        ...
        def calculate_data_gpu(self,x,y):
            ...
            cuda.synchronize()
            self.set_data(device_data.copy_to_host())
